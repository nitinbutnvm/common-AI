...
const GenerateImages = () => {
  ...
  const imageStyle = ['Realistic', 'Polaroid style', 'Ghibli style', 'Anime style', 'Cartoon style',
  ...
  return (
    ...
    flex items-start flex-wrap gap-4 text-slate-700">
      {/* left col */}
      ...
      rounded-lg border border-gray-200">
        ...
        value={input}  rows={4} className="w-full p-2 px-3
    ...
    {imageStyle.map((item)=>(
      ...
      cursor-pointer ${selectedStyle === item ?
      ...
      <button disabled={loading} className="w-full flex justify-center gap-2 bg-gradient-to-r
      from-[#00AD25] to-[#04FF50] text-white px-4 py-2 mt-4
      ...
      flex-col border border-gray-200 min-h-96 ">
        ...
        {!content ? (<div className="flex items-center flex-1 justify-center">
