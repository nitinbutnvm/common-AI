...
import { Eraser, Hash, House, Image, LogOut, SquarePen, Users } from "lucide-react"
...
const Sidebar = ({ sidebar, setSidebar }) => {
    ...
    flex-col justify-between items-center max-sm:absolute
    top-14 bottom-0 ${sidebar ? 'translate-x-0' :
            ...
            flex items-center justify-between">
                ...
                <LogOut onClick={signOut} className="w-4.5
                text-gray-400 hover:text-gray-700 transition cursor-pointer" />
            </div>
